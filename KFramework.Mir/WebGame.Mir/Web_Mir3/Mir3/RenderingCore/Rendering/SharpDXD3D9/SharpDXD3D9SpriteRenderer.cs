...
namespace Shared.Rendering.SharpDXD3D9
{
    public sealed class SharpDXD3D9SpriteRenderer : IDisposable
    {
        ...
        public void DrawOutlined(Texture texture, RectangleF destination, Rectangle? source, Color color, NumericsMatrix3x2 transform, Color4 outlineColor, float outlineThickness)
        {
        ...
        public void DrawGrayscale(Texture texture, RectangleF destination, Rectangle? source, Color color, NumericsMatrix3x2 transform)
        {
        ...
        public void DrawDropShadow(Texture texture, RectangleF destination, RectangleF shadowBounds, Rectangle? source, Color color, NumericsMatrix3x2 transform, SharpDX.Mathematics.Interop.RawColor4 shadowColor, float shadowWidth, float shadowMaxOpacity)
        {
