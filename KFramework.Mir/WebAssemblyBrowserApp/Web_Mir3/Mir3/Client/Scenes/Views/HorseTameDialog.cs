...
namespace Client.Scenes.Views
{
    public sealed class HorseTameDialog : DXControl
    {
        ...
        // 限定 MirEngine.Timer：System.Threading.Timer 与 shim 的 Timer 同名，直接写会歧义。
        private MirEngine.Timer _promptTimer, _resultTimer;
        ...
        public HorseTameDialog()
        {
            ...
            _promptTimer = new MirEngine.Timer();
            _promptTimer.Tick += PromptTimer_Tick;

            _resultTimer = new MirEngine.Timer
            {
