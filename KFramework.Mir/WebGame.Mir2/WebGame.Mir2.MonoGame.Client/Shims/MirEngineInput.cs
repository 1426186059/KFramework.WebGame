...
namespace MirEngine
{
    // 原 Web_Mir2.Engine/MirEngine/Shims/Keyboard.cs + Mouse.cs + KeyPress.cs + PreviewKeyDown.cs
    // 注意：KeyEventHandler / MouseEventHandler / KeyPressEventHandler 委托由本工程 WinFormsExtra.cs 统一提供，此处不重复定义。
    ...
    public class KeyEventArgs : EventArgs
    {
        ...
        public virtual Keys KeyCode => (KeyData & Keys.Modifiers) == 0 ? KeyData : KeyData & ~Keys.Modifiers;
