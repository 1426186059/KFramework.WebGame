...
using DrawingInterpolationMode = Drawing2D.InterpolationMode;
using DrawingPixelFormat = Imaging.PixelFormat;
using Factory = SharpDX.DXGI.Factory1;
using GdiRectangle = Rectangle;
using GdiPoint = Point;
...
namespace Shared.Rendering.SharpDXD3D11
{
    ...
    public static class SharpDXD3D11Manager
    {
        ...
        private static Timer _postTogglePlacementTimer;
        ...
        public static void ColorFill(RenderSurface surface, Rectangle rect, Color color)
        {
            if (!surface.IsValid)
                return;
