 ...
 */
const svgUrl = (body: string, w: number, h: number): string => {
    const svg =
...
const ARROW =
    '<path d="M3 1 L3 17 L7.5 13.2 L10.5 20.5 L13.4 19.2 L10.5 12 L16.5 12 Z" ' +
    'fill="#ffffff" stroke="#000000" stroke-width="1.2" stroke-linejoin="round"/>';

// 攻击：红色准星（热点居中 12,12）
const ATTACK =
    '<path d="M12 2 L12 22 M2 12 L22 12" stroke="#ff3b30" stroke-width="2"/>' +
 ...
 */
export const setCursor = (name: string): void => {
    try {
