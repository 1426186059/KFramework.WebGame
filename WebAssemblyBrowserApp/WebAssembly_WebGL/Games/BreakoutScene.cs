...
public sealed class BreakoutScene : GameScene
{
    ...
    private void RenderParticles()
    {
        ...
        {
            WebGL.Alpha(p.Alpha);
            WebGL.FillCircle(p.Position.X, p.Position.Y, p.Size * p.Alpha + 0.6, p.Color);
        }
        WebGL.Alpha(1);
    }
    ...
    private void RenderPaddle()
    {
        ...
        WebGL.NoShadow();
        WebGL.RoundedRect(p.Position.X - p.Width / 2 + 5, p.Position.Y - p.Height / 2 + 3, p.Width - 10, p.Height * 0.45, 6, "#ffffff33");
    }
    ...
    private void RenderBall()
    {
        ...
        WebGL.NoShadow();
        WebGL.FillCircle(b.Position.X - 2, b.Position.Y - 2, b.Radius * 0.45, "#fff8d6");
    }
