...
public sealed class XiYouJiScene : GameScene
{
    ...
    {
        public void Clear(string color) => WebGPU.Clear(color);
        public void FillRect(float x, float y, float w, float h, string color) => WebGPU.FillRect(x, y, w, h, color);
        public void FillCircle(float cx, float cy, float r, string color) => WebGPU.FillCircle(cx, cy, r, color);
        public void FillText(string text, float x, float y, string font, string color, string align) => WebGPU.FillText(text, x, y, font, color, align);
        public void Alpha(float a) => WebGPU.Alpha(a);
    }
}
