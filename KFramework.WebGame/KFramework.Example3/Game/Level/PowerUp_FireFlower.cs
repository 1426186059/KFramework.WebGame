...
{
    internal class PowerUp_FireFlower : PowerUpObject
    {
        ...
        public PowerUp_FireFlower(Level level, Vector2 position) : base(level, position, 0)
        {
            LoadContent();
        ...
        private void LoadContent()
        {
            ...
            mSpriteRenderer.Sprite = new KSprite(mLevel.mSpriteSheet_misc3Atlas.Sprite("misc-3_22"));
