...
{
    internal class PowerUp_OneUpMushroom : PowerUpObject
    {
        ...
        public PowerUp_OneUpMushroom(Level level, Vector2 position) : base(level, position, 150)
        {
            LoadContent();
        ...
        private void LoadContent()
        {
            ...
            mSpriteRenderer.Sprite = new KSprite(mLevel.mSpriteSheet_misc3Atlas.Sprite("misc-3_4"));
