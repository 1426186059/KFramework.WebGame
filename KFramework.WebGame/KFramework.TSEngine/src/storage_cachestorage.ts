...
export async function GetCacheSizeAsync(cacheName: string, key: string): Promise<number> {
...
export async function RemoveCacheListAsync(cacheName: string, removeList: string[]): Promise<number> {
...
export async function RemoveAllCacheAsync(cacheName: string): Promise<void> {
